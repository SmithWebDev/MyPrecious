...
vim.keymap.set('n', '<leader>Y',            "\"+Y",                         {desc = 'Yank text to System Clipboard'})
vim.keymap.set('v', '<leader>Y',            "\"+Y",                         {desc = 'Yank text to System Clipboard'})
vim.keymap.set('n', '==',                   'gg=G<c-o>',                    {desc = 'Easy indent return cursor to previous line'})
...
--[[ Tabs ]]--------------------------------------------------------------------
vim.keymap.set("n", '<Tab>tc',              ':tabc<CR>',                    { desc = 'Close Tab' })
vim.keymap.set("n", '<Tab>te',              ':tabedit %<CR>',               { desc = 'Edit File in Tab' })
vim.keymap.set("n", '<Tab>th',              ':tabfirst<CR>',                { desc = 'Goto Tab First' })
vim.keymap.set("n", '<Tab>tJ',              ':tabn<Space>',                 { desc = 'Goto Tab Next' })
vim.keymap.set("n", '<Tab>tj',              ':tabn<Space><CR>',             { desc = 'Goto Tab Next' })
vim.keymap.set("n", '<Tab>tK',              ':tabp<Space>',                 { desc = 'Goto Tab Previous' })
vim.keymap.set("n", '<Tab>tk',              ':tabp<Space><CR>',             { desc = 'Goto Tab Previous' })
vim.keymap.set("n", '<Tab>tl',              ':tablast<CR>',                 { desc = 'Goto Tab Last' })
vim.keymap.set("n", '<Tab>tN',              ':tabnew<Space>',               { desc = 'Goto Tab New' })
vim.keymap.set("n", '<Tab>tn',              ':tabnew<Space><CR>',           { desc = 'Goto Tab New' })
vim.keymap.set("n", '<Tab>to',              '<C-w>T',                       { desc = 'Open File In New Tab' })
vim.keymap.set("n", '<Tab>t%',              '<C-w>T',                       { desc = 'Open File In New Tab' })
vim.keymap.set("n", '<Tab>tt',              ':tabs',                        { desc = 'Show Tab List' })
