...
function M.on_attach(client, bufnr)
  ...
  nnoremap('<leader>LI', ':LspInstall cssls elixirls emmet_ls html jsonls solargraph sumneko_lua tsserver vuels yamlls tailwindcss<CR>', { desc = 'Install Lsp Languages'})
